...
<div class="row-fluid">
    <div class="span12">
        <div class="box">
            <header>
                <h5>Adroddiad Aelodaeth: <?=$month?> <?=$year?></h5>
            </header>
        <div class="body">
            <p>Dim ond taliadau sydd wedi'u cadarnhau sydd yn ymddangos yma. </p>
            ...
            <form action="" method="post" class="form">
                ...
                <div class="control-group span5 offset7">
                    ...
                    <div class="controls span7">
                        ...
                        <span class="help-block">Dewis mis er mwy gweld yr adroddiad</span>
                    </div>
                    
                    <button type="submit" class="btn btn-primary">Dangos Adroddiad</button>
                </div>
